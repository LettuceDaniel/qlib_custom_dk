...
# Load .env from RD-Agent directory
env_path = Path(__file__).parent.parent.parent / ".env"
load_dotenv(env_path)
# 1) Make sure it is at the beginning of the script so that it will load dotenv before initializing BaseSettings.
# 2) Load from RD-Agent directory to ensure .env is found regardless of current directory.
...
from rdagent.app.qlib_rd_loop.sota import main as fin_sota
...
app.command(name="fin_sota")(fin_sota)

...
class ModelCoSTEER(CoSTEER):
    def __init__(
        ...
        **kwargs,
        ...
        es = ModelMultiProcessEvolvingStrategy(scen=scen, settings=MODEL_COSTEER_SETTINGS)

        super().__init__(*args, settings=MODEL_COSTEER_SETTINGS, eva=eva, es=es, evolving_version=2, scen=scen, **kwargs)
